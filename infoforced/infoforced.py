...
class Foo(commands.Cog):
    ...
    async def about(self, ctx):
        ...
        embed.add_field(
            ...
            "to have a Modmail bot of your own please contact him. Join https://discord.gg/wantuh or Email contact@wantuh.com for any support or questions.",
            inline=False,
        )

        embed.add_field(
            name="Modmail",
            value="Open source bot on [GitHub](https://github.com/khakers/OpenModmail/), stable version "
